...
import team3176.robot.subsystems.vision.AprilTagVisionIO.AprilTagVisionIOInputs;

public class AprilTagVisionIONorthstar {
  private static final int cameraId = 0;
  private static final int cameraResolutionWidth = 1920;
  private static final int cameraResolutionHeight = 1080;
  ...
  public AprilTagVisionIONorthstar(String identifier) {
    ...
    configTable.getDoubleTopic("fiducial_size_m").publish().set(.03);
